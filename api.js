...
const Api = {
  ...
  // Kiểm tra email có được phép nộp đề cử cho chuỗi WinMart/MiniMart hay không (SSC luôn cho phép).
  // Dùng ở bước "cổng" trên index.html trước khi mở khóa phần còn lại của form.
  checkSubmitterAllowed: (email, loaiDonVi) => jsonp('checkSubmitterAllowed', { email, loaiDonVi }),
